...
const vaultDetailsForm = ({vault, vaultDetails}) => {
  ...
  const isButtonDisabled = !inputValue || parseFloat(inputValue) > balance || (vaultDetails.status == "Withdraw Only" && direction == "Deposit") || chainId != 42161
